...
export default function Compete() {
  ...
  useEffect(() => {
    ...
    axios
      .post(`https://blocsoc.iitr.ac.in/solsec/contest/get/${id}`, {
        contest,
  ...
  const startContest = () => {
    axios
      .patch(`https://blocsoc.iitr.ac.in/solsec/contest/start/${id}`)
      .then((res) => {
        setContestStatus(res.data.data.contest.contestStatus);
  ...
  const endContest = () => {
    axios
      .patch(`https://blocsoc.iitr.ac.in/solsec/contest/stop/${id}`)
      .then((res) => {
        setContestStatus(res.data.data.contest.contestStatus);
        console.log(res);
      })
  ...
  const participate = () => {
    axios
      .patch(
        `https://blocsoc.iitr.ac.in/solsec/auditor/participate/${id}/${currentUser._id}`
      )
      .then((res) => {
        console.log(res);
      })
    ...
    <>
      ...
      <section className="compete-container">
        <div className="compete-box">
          ...
          {contestStatus === 3 ? (
            <div className="competition-status">Live</div>
          ) : null}
          {contestStatus > 1 && contestStatus < 3 ? (
            <div className="competition-status">Upcoming</div>
          ) : null}
              ...
              <div className="protocol-content">
                ...
                <div className="prizes-veticleLine">
                  ...
                  <div className="proposal-prizes">
                    Total Prize Pool: {Prize.pool} <br /> HM awards:{" "}
                    {Prize.HMawards}
                    <br />
            ...
            <div className="price-details">
              ...
              <div className="competition-dates">
                ...
                <div className="competition-duration">
                  {" "}
                  Start Date: {contest.startDate} <br /> Duration:{" "}
              ...
              <div className="buttons">
                ...
                currentUser.role === "auditor" ? (
                  <button className="findings" onClick={participate}>
                    Participate
                  </button>
                ) : null}
                {contestStatus === 3 && currentUser.role === "auditor" ? (
                  <button className="findings" onClick={participate}>
